...
- 👨‍💻 Currently diving deep into **Springboot** and **Java**  
- 🧠 Exploring cloud architecture with **AWS** and **Azure**  
- 🔭 Working on backend services, image rendering, and performance-focused systems
- 🌐 Passionate about building systems that are as beautiful inside (code) as they are outside (UX)
- 🎮 Love crafting experiences across **Backend**, **DevOps**
